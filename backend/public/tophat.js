...
var _user$project$Request_Drink$drink = function (slug) {
	return A2(
		...
		_user$project$Request_Helpers$apiUrl(
			A2(_elm_lang$core$Basics_ops['++'], '/drinks/', slug)),
		_user$project$Data_Drink$drinkDecoder);
};

var _user$project$Page_Drink$viewIngredient = function (v) {
		...
		A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					v.unit,
					A2(_elm_lang$core$Basics_ops['++'], ' ', v.name)))));
};
var _user$project$Page_Drink$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
														...
														A2(
															...
															function (v) {
																return A2(
																	...
																	{
																		ctor: '::',
																		_0: _user$project$Page_Drink$viewIngredient(v),
																		_1: {ctor: '[]'}
																	});
															},
...
var _user$project$Request_Index$index = A2(
	_elm_lang$http$Http$get,
	_user$project$Request_Helpers$apiUrl('/drinks'),
...
var _user$project$Page_Home$UpdateUrl = function (a) {
...
var _user$project$Views_Page$viewSearchBar = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _user$project$Views_Page$viewHeader = function (isLoading) {
	return A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Tophat'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$Views_Page$frame = F2(
	function (isLoading, content) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Views_Page$viewHeader(isLoading),
				_1: {
					ctor: '::',
					_0: content,
					_1: {ctor: '[]'}
...
var _user$project$Main$Drink = function (a) {
	return {ctor: 'Drink', _0: a};
};
...
var _user$project$Main$pageErrored = F2(
	function (model, errorMessage) {
		var error = _user$project$Page_Errored$pageLoadError(errorMessage);
		return A2(
...
var _user$project$Main$viewPage = F2(
	function (isLoading, page) {
		...
		switch (_p1.ctor) {
			...
			case 'Errored':
				return frame(
					_user$project$Page_Errored$view(_p1._0));
			case 'Home':
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Main$HomeMsg,
					frame(
						_user$project$Page_Home$view(_p1._0)));
			default:
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Main$DrinkMsg,
					frame(
						_user$project$Page_Drink$view(_p1._0)));
		}
	});
...
var _user$project$Main$DrinkLoaded = function (a) {
	return {ctor: 'DrinkLoaded', _0: a};
};
	...
	function (maybeRoute, model) {
		...
		if (_p3.ctor === 'Nothing') {
			...
			if (_p3._0.ctor === 'Home') {
				...
				return A2(
					transition,
					_user$project$Main$DrinkLoaded,
					_user$project$Page_Drink$init(_p3._0._0));
			}
		}
	});
var _user$project$Main$init = F2(
	function (_p4, location) {
		return A2(
	...
	function (page, msg, model) {
		...
		do {
			switch (_p6._0.ctor) {
					...
					if (_p6._0._0.ctor === 'Ok') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									pageState: _user$project$Main$Loaded(
										_user$project$Main$Drink(_p6._0._0._0))
								}),
							_elm_lang$core$Platform_Cmd$none);
					} else {
						return A2(
				...
				case 'HomeMsg':
					if (_p6._0._0.ctor === 'UpdateUrl') {
						return A2(
							_user$project$Main_ops['=>'],
							model,
							_user$project$Route$newUrl(_p6._0._0._0));
					} else {
						if (_p6._1.ctor === 'Home') {
				...
				default:
					if (_p6._1.ctor === 'Drink') {
						return A5(toPage, _user$project$Main$Drink, _user$project$Main$DrinkMsg, _user$project$Page_Drink$update, _p6._0._0, _p6._1._0);
					} else {
						break _v4_8;
					}
			}
